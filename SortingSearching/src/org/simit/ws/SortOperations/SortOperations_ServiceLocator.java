...
public class SortOperations_ServiceLocator extends org.apache.axis.client.Service implements org.simit.ws.SortOperations.SortOperations_Service {
    ...
    private java.lang.String SortOperationsSOAP_address = "http://www.example.org/";
    ...
    public org.simit.ws.SortOperations.SortOperations_PortType getSortOperationsSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public org.simit.ws.SortOperations.SortOperations_PortType getSortOperationsSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.simit.ws.SortOperations.SortOperationsSOAPStub _stub = new org.simit.ws.SortOperations.SortOperationsSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.simit.ws.SortOperations.SortOperations_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.simit.ws.SortOperations.SortOperationsSOAPStub _stub = new org.simit.ws.SortOperations.SortOperationsSOAPStub(new java.net.URL(SortOperationsSOAP_address), this);
                _stub.setPortName(getSortOperationsSOAPWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.example.org/SortOperations/", "SortOperations");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.example.org/SortOperations/", "SortOperationsSOAP"));
        }
