...
public class SortOperationsProxy implements org.simit.ws.SortOperations.SortOperations_PortType {
  private String _endpoint = null;
  private org.simit.ws.SortOperations.SortOperations_PortType sortOperations_PortType = null;
  ...
  private void _initSortOperationsProxy() {
    try {
      sortOperations_PortType = (new org.simit.ws.SortOperations.SortOperations_ServiceLocator()).getSortOperationsSOAP();
  ...
  public org.simit.ws.SortOperations.SortOperations_PortType getSortOperations_PortType() {
    if (sortOperations_PortType == null)
      _initSortOperationsProxy();
